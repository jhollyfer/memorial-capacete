        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <Link to="#hero" className="flex items-center text-white mb-4">
              ...
              <div className="font-heading font-bold">Memorial do Capacete</div>
            </Link>
            <p className="text-white/80 mb-4">
              Preservando a memória do Massacre do Capacete e honrando a
              resistência do povo Ticuna.
            </p>
            <p className="text-white/70 text-sm">
              © {new Date().getFullYear()} Memorial do Massacre do Capacete.
              <br />
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="#hero" className="text-white/80 hover:text-white">
                  Início
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="#legado" className="text-white/80 hover:text-white">
                  Legado
                </Link>
              </li>
              <li>
                <Link to="#memorial" className="text-white/80 hover:text-white">
                  Memorial
                </Link>
              </li>
            </ul>
