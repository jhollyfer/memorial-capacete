...
const legacyItems = [
  ...
  },
  {
    ...
    description:
      "O fortalecimento das organizações indígenas e a articulação com movimentos sociais e entidades de apoio foi uma resposta à violência sofrida. O Conselho Geral da Tribo Ticuna (CGTT), fundado em 1982, ganhou força após o massacre e inspirou a criação de outras organizações indígenas na região amazônica.",
    icon: "✊",
    link: "",
  },
  {
...
const impactItems = [
  {
    ...
    description:
      "O massacre inspirou produções artísticas e culturais, como poemas, músicas e pinturas que retratam a resistência e a memória Ticuna.",
    image: "placeholder-ticuna-art.jpg",
  },
  {
    title: "Legislação Indígena",
    description:
      "O caso contribuiu para o debate sobre a necessidade de legislação específica para a proteção dos direitos e territórios indígenas no Brasil.",
    image: "placeholder-indigenous-legislation.jpg",
  },
  {
    title: "Fortalecimento Identitário",
    description:
      "Após o massacre, o povo Ticuna intensificou processos de autoafirmação cultural e valorização de suas tradições como forma de resistência.",
...
const ticunaHistory = [
  {
    ...
    description:
      "O povo Ticuna (também grafado como Tikuna, Tukuna ou Magüta) habita tradicionalmente a região amazônica da tríplice fronteira entre Brasil, Peru e Colômbia há milênios. Segundo sua cosmologia, são descendentes de Yo'i, herói mítico que os pescou com iscas de macaxeira no igarapé sagrado Eware.",
    image: "placeholder-ticuna-origins.jpg",
  },
  {
    title: "Organização Social",
    description:
      "A sociedade Ticuna é tradicionalmente organizada em clãs patrilineares divididos em duas metades: com penas (aves) e sem penas (animais terrestres e plantas). Essa organização regula os casamentos, que devem ocorrer entre pessoas de clãs opostos, evitando o que consideram incesto.",
    image: "placeholder-ticuna-social.jpg",
  },
  {
    title: "Contato e Resistência",
    description:
      "O contato com os colonizadores europeus data do século XVII. Os Ticuna sofreram com a escravidão durante o ciclo da borracha e foram forçados a trabalhar nos seringais. Ao longo dos séculos, desenvolveram estratégias de resistência cultural e territorial que permitiram sua sobrevivência como povo.",
      ...
      <div className="memorial-container">
        <div className="text-center mb-16">
          ...
          <p className="text-white/80 max-w-3xl mx-auto">
            Como o Massacre do Capacete influenciou a luta dos povos indígenas e
            a sociedade brasileira, transformando a tragédia em força para
        ...
        <div className="mb-20">
          <h3 className="text-2xl font-bold mb-8 text-white text-center">
            O Povo Ticuna: Origens e História
          </h3>
          <div className="grid md:grid-cols-3 gap-8">
            {ticunaHistory.map((item, index) => (
              <Card
                key={index}
                className="bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/15 transition-colors overflow-hidden"
              >
                {/* <div className="h-48 overflow-hidden bg-memorial-dark/50 flex items-center justify-center">
                  <p className="text-white/50 text-sm px-4 py-2 border border-white/20 rounded">
                    {index === 0
                      ? "Imagem: Origens e cosmologia Ticuna"
                      : index === 1
                      ? "Imagem: Organização social Ticuna"
          ...
          <div className="mt-8 bg-white/10 p-6 rounded-lg">
            <h4 className="text-xl font-bold mb-3 text-white">
              Dados Demográficos e Linguísticos
            </h4>
            <p className="text-white/80 mb-4">
              Os Ticuna constituem o povo indígena mais numeroso da Amazônia
              brasileira, com uma população estimada em mais de 36.000 pessoas
              no Brasil, principalmente no estado do Amazonas, além de cerca de
              7.000 no Peru e 8.000 na Colômbia. A língua Ticuna é considerada
              isolada, sem parentesco comprovado com outras línguas indígenas, o
              que evidencia sua singularidade cultural e histórica na região
              amazônica.
            </p>
        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {impactItems.map((item, index) => (
              <div
                key={index}
                className="rounded-lg overflow-hidden group bg-memorial-dark/70"
              >
        ...
        <div className="mt-16 text-center max-w-3xl mx-auto">
          <blockquote className="text-xl text-white/90 italic">
            "O sangue derramado no massacre irrigou as sementes da resistência
            que hoje florescem na luta dos povos originários por reconhecimento
            e dignidade. O massacre não foi o fim, mas o início de uma nova fase
            da luta Ticuna."
          </blockquote>
