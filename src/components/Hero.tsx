    ...
    >
      ...
      <div className="memorial-container relative z-10 text-center px-4">
        <div className="animate-fade-in opacity-0" style={{ animationDelay: '0.3s' }}>
          <p className="text-memorial-beige uppercase tracking-wider mb-4">28 de março de 1988 | Alto Solimões, Amazonas</p>
          ...
          <p className="text-white/80 max-w-2xl mx-auto mb-8">
            Um ataque que resultou em <span className="text-memorial-accent font-bold">4 mortos confirmados</span>, 
            <span className="text-memorial-accent font-bold"> 23 feridos</span> e 
            <span className="text-memorial-accent font-bold"> 10 desaparecidos</span>, 
            marcando um dos episódios mais violentos contra povos indígenas na história recente do Brasil.
          </p>
